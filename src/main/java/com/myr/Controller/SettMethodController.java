...
public class SettMethodController {
    ...
    public String SettIndex(Model model,HttpServletRequest request) {
        String AllQuery = request.getParameter("AllQuery");
        List<SettlementMethod> settlementMethods = settMethodService.settMethod_index(AllQuery);
        model.addAttribute("datas",settlementMethods);
